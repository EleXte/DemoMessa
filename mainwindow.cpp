...
void MainWindow::st_openCalc()
{
    CalcWin = new AE_CalcWidget();
    CalcWin->show();
}
...
void MainWindow::createActions()
{
    ...
    openCalc = new QAction(tr("Open &Calc"), this);
    openCalc->setStatusTip(tr("Just calculator to MATH!"));
    connect(openCalc, SIGNAL(triggered()), this, SLOT(st_openCalc()));
}
...
void MainWindow::createMenus()
{
    ...
    calcMenu = menuBar()->addMenu(tr("Calculator"));
    calcMenu->addAction(openCalc);
}
